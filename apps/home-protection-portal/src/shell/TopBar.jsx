// TopBar — dev-panel toggle + app brand. Structural twin of
// protection-portal/src/shell/TopBar.jsx with the home iconography.
    ...
    <div className="flex items-center justify-between px-6 py-3 bg-white border-b border-slate-200">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold tracking-tight">Home Protection Portal</span>
          {view && (
            <>
      ...
      <div className="text-xs text-slate-500">Wave 39 · ADR 30</div>
    </div>
  );
}
